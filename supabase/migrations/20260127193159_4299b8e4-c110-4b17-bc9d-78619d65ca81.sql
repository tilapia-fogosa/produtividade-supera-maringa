-- Função para buscar professores disponíveis em um horário específico
-- Verifica conflitos com turmas regulares e eventos pontuais/recorrentes
...
BEGIN
  ...
  -- Se unit_id não foi passado, usar Maringá como padrão
  ...
  WHERE p.status = true
    ...
    -- Excluir professores com turmas regulares no mesmo dia/horário
    AND NOT EXISTS (
    ...
    -- Excluir professores com eventos pontuais na data específica
    AND NOT EXISTS (
