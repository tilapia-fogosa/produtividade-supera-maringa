-- Adicionar contagem de faltas futuras ao calendário de turmas
...
-- Garantir permissões
GRANT EXECUTE ON FUNCTION public.get_calendario_turmas_semana_com_reposicoes(date, date) TO anon, authenticated;