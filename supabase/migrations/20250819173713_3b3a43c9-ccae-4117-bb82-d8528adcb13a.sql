-- Atualizar a função get_turma_modal_data para incluir funcionários
...
BEGIN
  SELECT json_build_object(
    ...
    'estatisticas', json_build_object(
      ...
      END,
      'media_idade', (
        SELECT ROUND(AVG(COALESCE(a.idade, f.idade)), 1)
        FROM (
      ...
      'media_dias_supera', (
        SELECT ROUND(AVG(COALESCE(a.dias_supera, f.dias_supera)), 0)
        FROM (
