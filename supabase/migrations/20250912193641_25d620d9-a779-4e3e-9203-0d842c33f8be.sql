-- Corrigir função get_turma_modal_data para incluir foto_url dos alunos e funcionários
        ...
        COALESCE(
          (SELECT json_agg(
            json_build_object(
              ...
              'telefone', a.telefone,
              'email', a.email,
              'data_falta', fa.data_falta,
              'responsavel_aviso_nome', fa.responsavel_aviso_nome,
