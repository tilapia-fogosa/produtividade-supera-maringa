-- Atualizar função get_calendario_turmas_semana_com_reposicoes para excluir turmas com projeto = true
...
BEGIN
  ...
  WHERE t.active = true
    -- NOVO FILTRO: Excluir turmas com projeto = true
