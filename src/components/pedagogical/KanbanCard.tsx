...
export function KanbanCard({ title, description, alunoNome, origem, responsavel, createdAt }: KanbanCardProps) {
  return (
    <Card className="p-3 mb-2 bg-white shadow-sm hover:shadow-md transition-shadow cursor-grab active:cursor-grabbing">
